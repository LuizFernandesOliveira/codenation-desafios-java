...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            if (this.placa.isEmpty() || this.cor == null){
                throw new NullPointerException("preencha todos os campos");
            }
            if (this.motorista == null) {
                throw new EstacionamentoException("precisa ter motorista");
            }
            if (this.motorista.getIdade() < 18) {
                throw new EstacionamentoException("não pode menor idade");
            }
            if (this.motorista.getPontos() > 20) {
                throw new EstacionamentoException("carteira suspensar");
            }
